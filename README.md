<div align="center">
  ...
  <img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=0,2,2,5,30&height=180&section=header&text=Vex%203%20Gamedistribution&fontSize=42&fontColor=fff&animation=fadeIn&fontAlignY=38" width="100%" style="max-width: 100%; border-radius: 12px; margin-bottom: 20px;" alt="Vex 3 Gamedistribution Header Banner" />

  <h1>🚀 Vex 3 Gamedistribution</h1>
  ...
  <p align="center">
    ...
    <a href="https://github.com/hsinidev/vex-3-gamedistribution"><img src="https://img.shields.io/badge/License-MIT-green?style=for-the-badge" alt="License: MIT" /></a>
  </p>
...
**Vex 3 Gamedistribution** delivers a fast, responsive, and cross-platform browser experience built with **JavaScript** and hardware-accelerated canvas rendering.
...
```bash
git clone https://github.com/hsinidev/vex-3-gamedistribution.git
cd vex-3-gamedistribution
```
